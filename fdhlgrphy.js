...
module.exports = fdhl = async (fdhl, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6289652300145@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Follow Instagram @sgal.x',
			error: {
...
Jangan Lupa Follow Instagram @sgal.x
...
//━━━━━━━━━━━━━━━[ FITUR STICKER ]━━━━━━━━━━━━━━━━━//
     ...
     case 'attp':
         ...
         costum(buffer, sticker, Verived, `Follow Instagram @sgal.x\nGithub LihhXd`)
         fs.unlinkSync(media)
         fs.unlinkSync(ran)
         })
     ...
     case 'tovideo':
         ...
         fs.unlinkSync(anum)
         buffer = fs.readFileSync(ran)
         fdhl.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Follow https://www.instagram.com/sgal.x' })
         fs.unlinkSync(ran)
         })
         break
     case 'donasi1':
...
//━━━━━━━━━━━━━━━[ FITUR OWNER ]━━━━━━━━━━━━━━━━━//
     ...
     case 'bc':
         ...
         for (let _ of anu) {
         fdhl.sendMessage(_.jid, bc, image, { caption: `[ Lihh\nIzin Broadcast ]\n\n${body.slice(4)}` })
         }
     ...
     case 'report':
         ...
         fdhl.sendMessage(`6289652300145@s.whatsapp.net`, options, text, { quoted: ftrol })
